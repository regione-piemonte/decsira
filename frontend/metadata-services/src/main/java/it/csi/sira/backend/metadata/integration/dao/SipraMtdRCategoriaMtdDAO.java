...
/**
 * SipraMtdRCategoriaMtd DAO interface
 * 
 * @author Telosys Tools
 */
public interface SipraMtdRCategoriaMtdDAO {
	...
	public List<SipraMtdRCategoriaMtd> findAll();
	
	public List<SipraMtdRCategoriaMtd> findByCriteria(java.util.Map<String, Object> params);
	public List<SipraMtdRCategoriaMtd> findByCriteria(MapSqlParameterSource params);
	...
	public List<SipraMtdRCategoriaMtd> findByGenericCriteria(String query, MapSqlParameterSource params);
	
	public void insert(SipraMtdRCategoriaMtd bean);

	public void update(SipraMtdRCategoriaMtd bean);
