  ...
  <NamedLayer>
    ...
    <!-- Styles can have names, titles and abstracts -->
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>rule1</Name>
          <Title>Risorse genetiche forestali</Title>
		  ...
		  <TextSymbolizer>
            <Label>
               <ogc:PropertyName>decsiraogc_idf_pop_seme:scheda</ogc:PropertyName>
            </Label>
            <Halo>
              <Radius>1</Radius>
              <Fill>
        ...
        <Rule>
		  ...
		  <TextSymbolizer>
            <Label>
               <ogc:PropertyName>decsiraogc_idf_pop_seme:scheda</ogc:PropertyName><![CDATA[-]]><ogc:PropertyName>decsiraogc_idf_pop_seme:nomep</ogc:PropertyName>
            </Label>
            <Halo>
              <Radius>1</Radius>
              <Fill>
