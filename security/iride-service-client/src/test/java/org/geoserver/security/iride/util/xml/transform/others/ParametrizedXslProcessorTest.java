 ...
 */
public final class ParametrizedXslProcessorTest extends AbstractOthersXslProcessorTest {

    /**
     * Parametrized <code>XSL</code>, <em>source</em> <code>XML</code> and <em>target</em> <code>XML</code> name.
     */
    private static final String TRANSFORMATION_NAME = "parametrized";

    /**
     * @param transformationName
     * @param params
     */
    public ParametrizedXslProcessorTest(String transformationName, Map<String, Object> params) {
