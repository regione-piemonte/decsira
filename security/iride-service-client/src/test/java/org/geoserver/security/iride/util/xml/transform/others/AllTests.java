...
/**
 * Other <code>XSL</code>s processing (using <code>XSL</code> transformation</a> processor) <code>JUnit</code> Test Suite.
 *
 * @author "Simone Cornacchia - seancrow76@gmail.com, simone.cornacchia@consulenti.csi.it (CSI:71740)"
 */
@RunWith(Suite.class)
@SuiteClasses({
    ParametrizedXslProcessorTest.class,
    ErroneousXslProcessorTest.class,
})
