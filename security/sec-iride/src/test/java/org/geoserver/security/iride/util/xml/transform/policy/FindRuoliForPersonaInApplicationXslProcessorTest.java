 ...
 */
public final class FindRuoliForPersonaInApplicationXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param policy
     */
    public FindRuoliForPersonaInApplicationXslProcessorTest(IridePolicy policy) {
        super(policy);
    }
