 ...
 */
public final class FindUseCaseForPersonaInApplicationTemplateCompilationTest extends AbstractIrideSoapRequestTemplateCompilationTest {
    ...
    public void setUp() throws Exception {
        this.getDataModel().putAll(new HashMap<String, Object>() {
...

            {
                ...
                put("application", new Application("DECSIRA"));
            }
        });
    }
    ...
    protected String getTemplateName() {
        return "findUseCasesForPersonaInApplication";
    }
