...
/**
 * <code>IRIDE</code> service <code>SOAP</code> <em>getInfoPersonaInUseCase</em> request template compilation (using <a href="http://freemarker.org/">FreeMarker</a>) <code>JUnit</code>.
 *
 * @author "Simone Cornacchia - seancrow76@gmail.com, simone.cornacchia@consulenti.csi.it (CSI:71740)"
 */
public final class GetInfoPersonaInUseCaseTemplateCompilationTest extends AbstractIrideSoapRequestTemplateCompilationTest {
    ...
    protected String getTemplateName() {
        return "getInfoPersonaInUseCase";
    }
