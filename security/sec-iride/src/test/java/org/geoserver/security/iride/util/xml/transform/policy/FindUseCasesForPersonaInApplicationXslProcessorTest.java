 ...
 */
public final class FindUseCasesForPersonaInApplicationXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param policy
     */
    public FindUseCasesForPersonaInApplicationXslProcessorTest(IridePolicy policy) {
        super(policy);
    }
