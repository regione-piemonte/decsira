 ...
 */
public final class GetInfoPersonaInUseCaseXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param operationName
     */
    public GetInfoPersonaInUseCaseXslProcessorTest(IridePolicy policy) {
    	super(policy);
    }
