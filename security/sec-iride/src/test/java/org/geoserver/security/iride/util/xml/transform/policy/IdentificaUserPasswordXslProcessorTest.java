 ...
 */
public final class IdentificaUserPasswordXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param policy
     */
    public IdentificaUserPasswordXslProcessorTest(IridePolicy policy) {
        super(policy);
    }
