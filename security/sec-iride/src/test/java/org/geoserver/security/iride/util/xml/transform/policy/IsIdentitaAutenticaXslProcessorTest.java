 ...
 */
public final class IsIdentitaAutenticaXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param policy
     */
    public IsIdentitaAutenticaXslProcessorTest(IridePolicy policy) {
        super(policy);
    }
