 ...
 */
public final class IsPersonaInRuoloXslProcessorTest extends AbstractIridePolicyResponseXslProcessorTest {
     ...
     * @param policy
     */
    public IsPersonaInRuoloXslProcessorTest(IridePolicy policy) {
        super(policy);
    }
