...
/**
 * <code>IRIDE</code> service <code>SOAP</code> <em>isPersonaInRuolo</em> request template compilation (using <a href="http://freemarker.org/">FreeMarker</a>) <code>JUnit</code>.
 *
 * @author "Simone Cornacchia - seancrow76@gmail.com, simone.cornacchia@consulenti.csi.it (CSI:71740)"
 */
public final class IsPersonaInRuoloTemplateCompilationTest extends AbstractIrideSoapRequestTemplateCompilationTest {
    ...
    public void setUp() throws Exception {
        this.getDataModel().putAll(new HashMap<String, Object>() {
...

            {
                ...
                put("role", Role.parseRole("PA_GEN_DECSIRA@REG_PMN"));
            }
        });
    }
    ...
    public void test() throws TemplateException, IOException {
        ...
        final Role role = (Role) this.getDataModel().get("role");
